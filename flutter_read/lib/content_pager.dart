...
import 'package:flutter_read/card/card_free.dart';
import 'package:flutter_read/card/card_recommend.dart';
import 'package:flutter_read/card/card_share.dart';
import 'package:flutter_read/card/card_special.dart';
...
class _ContentPagerState extends State<ContentPager> {
  ...
  //状态栏样式--沉浸式状态栏
  _statusBar(){
    //黑色沉浸式状态栏，基于SystemUiOverLayStyle.dark修改了statusBar
